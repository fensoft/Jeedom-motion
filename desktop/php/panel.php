...
foreach ($allObject as $object_li) {
	...
	if ($object_li->getId() == $object->getId()) {
		echo '<li class="cursor li_object active" ><a href="index.php?v=d&p=panel&m=motion&object_id=' . $object_li->getId() . '" style="position:relative;left:' . $margin . 'px;">' . $object_li->getHumanName(true) . '</a></li>';
	} else {
		echo '<li class="cursor li_object" ><a href="index.php?v=d&p=panel&m=motion&object_id=' . $object_li->getId() . '" style="position:relative;left:' . $margin . 'px;">' . $object_li->getHumanName(true) . '</a></li>';
	}
}
?>
        </ul>
...
<?php include_file('desktop', 'panel', 'js', 'motion');?>
