        ...
        success: function (objects) {
            ...
            for (var i in objects) {
                if (objects[i].isVisible == 1) {
                    ...
                    li += '<li></span><a href="#" class="link" data-page="panel" data-plugin="motion" data-title="' + icon.replace(/\"/g, "\'") + ' ' + objects[i].name + '" data-option="' + objects[i].id + '"><span>' + icon + '</span> ' + objects[i].name + '</a></li>';
                }
            }
            li += '</ul>';
            panel(li);
